...
public class GoodsController {
	...
	public String publishGoodsSubmit(HttpServletRequest request, Image ima, Goods goods, MultipartFile image)
		...
		String describle = goods.getDescrible();
...
//        String content = "areful1997";
        name = AESUtil.encodeToBase64String(name, key, iv);
        describle = AESUtil.encodeToBase64String(describle, key, iv);
...
//      		System.out.println("随机生成的私钥为:" + RSAEncrypt.keyMap.get(1));
      		name = RSAEncrypt.encrypt(name,RSAEncrypt.keyMap.get(0));
      		describle = RSAEncrypt.encrypt(describle,RSAEncrypt.keyMap.get(0));
...
//        System.out.println(plain);
		...
		FileOutputStream out = new FileOutputStream("D:/kv/kv"+goods.getId()+".object");
		ObjectOutputStream objectOutputStream = new ObjectOutputStream(out);
		objectOutputStream.writeObject(key);
		objectOutputStream.writeObject(iv);
		objectOutputStream.writeObject(RSAEncrypt.keyMap);
